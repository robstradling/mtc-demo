...
Generated by Claude Opus 4.6 from the following prompts:
- Implement draft-ietf-plants-merkle-tree-certs-03
- Create README.md with full documentation
- Update implementation to draft-ietf-plants-merkle-tree-certs-04
